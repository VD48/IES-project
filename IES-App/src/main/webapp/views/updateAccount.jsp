...
<body>
 <div align="center">
    <font color="greeen">${succMsg }</font>
     <font color="red">${Msg }</font>
    <font color="red"><h2>Update Account</h2></font>
    <form:form action="/update" modelAttribute="account" method="post">
			<table>
			    <tr>
					<th>Sr no</th>
				</tr>
				<tr>
					<td><form:input path="srNo" readonly="true"/></td>
				</tr>
				<tr>
					<th>First Name</th>
				</tr>
				...
				<tr>
					<td><form:input path="emailAdd" id="emailAdd" maxlength="12" required="required" /> <font
				...
				<tr>
					<td><form:input path="dob" id="datepicker" maxlength="12" required="required"/></td>
				</tr>
